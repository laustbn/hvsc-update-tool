//
// /home/ms/source/sidplay/libsidplay/include/RCS/myendian.h,v
//
...
#if defined(LO) || defined(HI) || defined(LOLO) || defined(LOHI) || \
    defined(HILO) || defined(HIHI)
...
inline udword readEndian(ubyte hihi, ubyte hilo, ubyte hi, ubyte lo) {
  return (((udword)hihi << 24) + ((udword)hilo << 16) + ((udword)hi << 8) +
          (udword)lo);
}
