...
const int SIDTUNE_SIDMODEL2_ANY =
    SIDTUNE_SIDMODEL2_6581 | SIDTUNE_SIDMODEL2_8580;
const int SIDTUNE_SIDMODEL3_6581 = 16;
const int SIDTUNE_SIDMODEL3_8580 = 32;
const int SIDTUNE_SIDMODEL3_ANY =
    SIDTUNE_SIDMODEL3_6581 | SIDTUNE_SIDMODEL3_8580;
...
class sidTune {
 public:  // ----------------------------------------------------------------
  ...
  void fixLoadAddress(bool force = false, uword initAddr = 0,
                      uword playAddr = 0);
